...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/dashboard', title: 'หน้าแรก', icon: 'ft-home', class: '', badge: '2', badgeClass: 'badge badge-pill badge-danger float-right mr-1 mt-1', isExternalLink: false, submenu: []
    },
    { path: '/team', title: 'ทีมงาน', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/saller', title: 'ผู้ขาย', icon: 'ft-user-check', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/customer', title: 'ลูกค้า', icon: 'ft-users', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/chat', title: 'แชท', icon: 'ft-message-square', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
