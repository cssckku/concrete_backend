    ...
    this.templateConf = {
      layout: {
        ...
        sidebar: {
          ...
          size: "sidebar-sm", // Options: 'sidebar-lg', 'sidebar-md', 'sidebar-sm'
          backgroundColor: "bg-glass-4", // Options: 'black', 'pomegranate', 'king-yna', 'ibiza-sunset', 'flickr', 'purple-bliss', 'man-of-steel', 'purple-love'
